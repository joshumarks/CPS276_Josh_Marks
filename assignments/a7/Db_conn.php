...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'jtmarks';//this will be your WCC username
      $dbUsr = 'jtmarks';//this will be your WCC username
      $dbPass = 'HsgAUKs3Jj9A';//this will be the password found in the video.
